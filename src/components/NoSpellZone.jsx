...
export default function NoSpell(props) {
  const style={
...
const handelLowerCase =()=>{
   ...
   const handelClear=()=>{
    ...
    <div style={style}>
<div className="mb-3" >
  <h1>No Spelling Check</h1>
  <h2 >Enter Text Here </h2>
  <textarea  className="form-control" style ={{backgroundColor:'transparent', resize:'none' ,color:props.mode==='light'?'black':'white' }}  id="my-box" rows="3" value={text} onChange={handelOnChange} spellCheck="false"></textarea>
